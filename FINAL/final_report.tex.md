...
\author{\IEEEauthorblockN{Renan Inacio}
...
## Relationships
- Sampson <-> Gregory: Co-servants, engage in banter about feud
- Benvolio <-> Romeo: Friends, Benvolio attempts to counsel Romeo
- Tybalt <-> Benvolio: Antagonists, Tybalt escalates conflict
...

## Key Events
- Act I, Scene I: Street brawl between Capulet/Montague servants
- Act I, Scene II: Capulet plans feast, Romeo learns of Rosaline
...
\end{verbatim}
